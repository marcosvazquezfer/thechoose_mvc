...
$view->setVariable("title", "Edit Participacion");

?><h1 class="bl"><?= i18n("Poll").": ".htmlentities($encuesta->getTitulo()) ?></h1><br>

<form id="ep" action="index.php?controller=encuestas&amp;action=editParticipation&amp;idEncuesta=<?= $encuesta->getIdEncuesta()?>" method="POST">
