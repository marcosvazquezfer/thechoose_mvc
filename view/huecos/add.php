...
$view->setVariable("title", "Add Hole");

?><h1 class="bl"><?= i18n("Create Hole")?></h1><br>

<form action="index.php?controller=huecos&amp;action=add&amp;idEncuesta=<?=$encuestaid?>" class= "mod1" method="POST">
	...
	<input type="submit" name="submit" class="btn btn-default" value="<?= i18n("CREATE") ?>">
</form>
